...
export const demoMissingPersons = [
  {
    ...
    name: 'Tafari Reid',
    age: 15,
    last_seen_location: 'St. Andrew',
    date_missing: new Date(Date.now() - 2*24*3600*1000).toISOString(),
    photo_url: '/src/assets/avatar1.svg',
    status: 'missing',
    description: 'Last seen near Half-Way-Tree Transport Centre wearing a white polo.',
  },
  {
    id: 102,
    name: 'Nia Morgan',
    age: 23,
    last_seen_location: 'St. Catherine',
    date_missing: new Date(Date.now() - 6*24*3600*1000).toISOString(),
    photo_url: '/src/assets/avatar2.svg',
    status: 'missing',
    description: 'Family is seeking any information. Last phone ping near Spanish Town Road.',
  },
  {
    id: 103,
    name: 'Marvin Thompson',
    age: 31,
    last_seen_location: 'St. James',
    date_missing: new Date(Date.now() - 9*24*3600*1000).toISOString(),
    photo_url: '/src/assets/avatar3.svg',
    status: 'missing',
    description: 'Reported missing after not returning from work shift in Montego Bay.',
  },
];
