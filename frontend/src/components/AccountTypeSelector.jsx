const accountTypes = [
  ...
  },
  {
    ...
    icon: '⭐',
    title: 'Personal Pro',
    description: 'Paid personal plan with more alert posting capacity and expanded safety tools.',
    badge: 'Paid',
  },
  {
    value: 'business',
    icon: '🏪',
    title: 'Business',
    description: 'Paid account for sponsored alerts, safety promotions, and future advertising tools.',
    badge: 'Paid',
  },
  {
    value: 'agency',
    icon: '🚓',
    title: 'Police / Agency',
    description: 'Licensed monthly or annual access for police departments and verified responders.',
    badge: 'License',
  },
];
